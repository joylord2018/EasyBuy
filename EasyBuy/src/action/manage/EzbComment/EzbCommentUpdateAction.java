...
public class EzbCommentUpdateAction extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1952355009283474909L;

	/**
	 * Constructor of the object.
	 */
	public EzbCommentUpdateAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int c=commentImpl.addReply(ecReply, ecId);
		if(c!=0){
