...
public class EzbProductCategoryUpdateAction extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 3851952419444411570L;

	/**
	 * Constructor of the object.
	 */
	public EzbProductCategoryUpdateAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int epc=Integer.parseInt(request.getParameter("epcId"));
		int e=epcs.updateParCategory(epcName,epc);
		if(e!=0){
