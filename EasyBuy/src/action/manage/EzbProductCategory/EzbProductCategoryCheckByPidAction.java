...
public class EzbProductCategoryCheckByPidAction extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 1927940480608413101L;

	/**
	 * Constructor of the object.
	 */
	public EzbProductCategoryCheckByPidAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		List<EzbProductCategory> epcsli=epcs.checkByPid(-1);
		request.setAttribute("epcsli", epcsli);
