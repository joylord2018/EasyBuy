...
public class EzbProductDeleteAction extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 444043821529631980L;

	/**
	 * Constructor of the object.
	 */
	public EzbProductDeleteAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int e=eps.deleteProduct(Integer.parseInt(request.getParameter("epId")));
		if(e!=0){
