...
public class EzbUserDeleteAction extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 6557025672622348695L;

	/**
	 * Constructor of the object.
	 */
	public EzbUserDeleteAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int a=userImpl.deleteUser(euDelete, euUserId);
		if(a!=0){
