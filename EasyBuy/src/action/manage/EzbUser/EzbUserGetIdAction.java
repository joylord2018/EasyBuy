...
public class EzbUserGetIdAction extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = 5367381013534863079L;

	/**
	 * Constructor of the object.
	 */
	public EzbUserGetIdAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		EzbUser user=userImpl.checkById(euUserId);
