...
public class EzbCommentAddAction extends HttpServlet {

	/**
	 * 
	 */
	private static final long serialVersionUID = -2853940769161139482L;

	/**
	 * Constructor of the object.
	 */
	public EzbCommentAddAction() {
		super();
	}
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		int e=ecs.addComment(content, name);
